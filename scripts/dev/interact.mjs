...
await p.goto('http://localhost:5173/?nav=3d'); await p.waitForSelector('canvas'); await p.waitForTimeout(2500)
const focused = []
...
const section = p.locator('header'); const box = await section.boundingBox()
